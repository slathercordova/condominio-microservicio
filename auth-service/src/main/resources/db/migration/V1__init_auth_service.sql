...
VALUES
('00000000-0000-0000-0000-000000000000', '00000000-0000-0000-0000-000000000000', 'ADMIN', '$2a$10$cQL.hWmztP4t./i9yeRcP.lHhxJuzG7/0TbrApLmHkbPO2SMh1zLe',
        '00000@xxx.xxx', 'SIN_BLOQUEO', false, 'ACTIVO','00000000-0000-0000-0000-000000000000'),
('11111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'PASSWORD_RECOVERY_JOB', '$2a$10$cQL.hWmztP4t./i9yeRcP.lHhxJuzG7/0TbrApLmHkbPO2SMh1zLe',
        '11111@xxx.xxx', 'SIN_BLOQUEO', false, 'ACTIVO','00000000-0000-0000-0000-000000000000'),
('22222222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', 'LCORDOVA', '$2a$10$cQL.hWmztP4t./i9yeRcP.lHhxJuzG7/0TbrApLmHkbPO2SMh1zLe',
        'slathercordova@gmail.com', 'SIN_BLOQUEO', false, 'ACTIVO','00000000-0000-0000-0000-000000000000'),
('33333333-3333-3333-3333-333333333333', '33333333-3333-3333-3333-333333333333', 'MACOSTA', '$2a$10$cQL.hWmztP4t./i9yeRcP.lHhxJuzG7/0TbrApLmHkbPO2SMh1zLe',
        'magda.acosta@essalud.gob.pe', 'SIN_BLOQUEO', false, 'ACTIVO','00000000-0000-0000-0000-000000000000'),
('44444444-4444-4444-4444-444444444444', '44444444-4444-4444-4444-444444444444', 'CFLORES', '$2a$10$cQL.hWmztP4t./i9yeRcP.lHhxJuzG7/0TbrApLmHkbPO2SMh1zLe',
        'clau.bill41@gmail.com', 'SIN_BLOQUEO', false, 'ACTIVO','00000000-0000-0000-0000-000000000000'),
('55555555-5555-5555-5555-555555555555', '55555555-5555-5555-5555-555555555555', 'YCORDOVA', '$2a$10$cQL.hWmztP4t./i9yeRcP.lHhxJuzG7/0TbrApLmHkbPO2SMh1zLe',
        'yahelcordova@gmail.com', 'SIN_BLOQUEO', false, 'ACTIVO','00000000-0000-0000-0000-000000000000');
